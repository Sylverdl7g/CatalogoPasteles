...
public class VentaPDF {
    ...
    public void generarFacturaPDF() {
        try {
            ...
            Image img = Image.getInstance("src/img/FONDO GRANDE.jpg");
            ...
            String ruc = "12345678";
            String nombre = "UMG PASTELES";
            String telefono = "78328487";
            String direccion = "La Antigua Guatemala";
            String razon = "WALTER-JOSE-SILVER-GERSON-KENNET S.A.";
            ...
            PdfPCell cliente1 = new PdfPCell(new Phrase("DPI: ", negrita));
           ...
           mensaje.add("¡Esperamos que vuelva pronto!");
